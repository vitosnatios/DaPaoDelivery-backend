    ...
    registerNewOrder(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const products = yield Product_1.default.findAll({ where: { id: productIds } });
                const productStockMap = new Map(products.map((product) => [product.id, Number(product.stock)]));
                ...
                for (const product of order_products) {
                    ...
                    yield Product_1.default.update({
                        stock: newStock,
                        purchased: sequelize_1.default.literal(`purchased + ${purchased}`),
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                for (const orderId of orderIds) {
                    ...
                    if (order) {
                        yield order.update({ closed: true });
                    }
                }
                res
                    .status(200)
